...
namespce myslam
{
    ...
    //这些坐标系变化的内容在第五章
    Vector3d Camera::world2camera (cons Vector3d& p_w, const SE3& T_c_w )
    {
        return T_c_w*p_w;
    
    }

    Vector3d Camera::camera2world (cons Vector3d& p_c, const SE3& T_c_w )
    {
        return T_c_w.inverse()*p_c;
    }

    Vector3d Camera::camera2pixel (cons Vector3d& p_c )
    {
        return Vector2d(
